...
module.exports = {
  ...
  links: {
    invite: process.env.INVITE ?? doc.links?.INVITE ?? 'https://discord.com/invite/VJxGnpKra7',
    support: process.env.SUPPORT ?? doc.links?.SUPPORT ?? 'https://discord.com/invite/VJxGnpKra7',
