...
module.exports = {
  ...
  execute: async (client, message, args, prefix) => {
   ...
   let count = new ActionRowBuilder().addComponents(srvrc, usrc, chc)
    ...
    let e = new client.emb().setThumbnail(client.user.displayAvatarURL()).setAuthor({name: client.user.username, iconURL: client.user.displayAvatarURL({dynamic: true})}).desc(`Meet me, **Cognixion Security**, the all-encompassing bot designed to power up your server in style! With my lightning-fast responses, interactive games, and robust moderation tools, we ensure your community stays engaged, entertained, and safe.`).setFooter({text: `Requested by ${message.author.username}`, iconURL: message.author.displayAvatarURL({dynamic: true})}).addFields([
      {
        name: `System Info`,
      ...
      {
        name: `Links`,
        value: `[Invite](${client.invite}) | [Support](${client.support}) | [Website](https://cognixion.online)`
      }])
      ...
      .addFields([{
        ...
        value: `[1] - <:Dev:1242814114380644372>[Ray](https://discord.com/users/1118271645191241860) [ID : 1118271645191241860]`,
        inline: false
      },
      {
        name: `<a:x_dot:1241064280124817529> Owners`,
        value: `[1] - <:owner:1242814025423917118>[Ray](https://discord.com/users/1118271645191241860) [ID : 1118271645191241860]`,
        inline: false
      }
                 ])
